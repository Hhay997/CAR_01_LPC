...
#define NRF24L01_SPI_CS_CLK_ENABLE()                  __HAL_RCC_GPIOG_CLK_ENABLE()
#define NRF24L01_SPI_CS_PORT                          SPI_CSN_GPIO_Port
#define NRF24L01_SPI_CS_PIN                             SPI_CSN_Pin
...
#define NRF24L01_CE_CLK_ENABLE()                      __HAL_RCC_GPIOG_CLK_ENABLE()
#define NRF24L01_CE_PORT                              SPI_CE_GPIO_Port
#define NRF24L01_CE_PIN                               SPI_CE_Pin
...
#define NRF24L01_IRQ_CLK_ENABLE()                     __HAL_RCC_GPIOG_CLK_ENABLE()
#define NRF24L01_IRQ_PORT                             SPI_IRQ_GPIO_Port
#define NRF24L01_IRQ_PIN                              SPI_IRQ_Pin
...
void nrf_RX(uint8_t tmp_buf[32]);//接收数据
void nrf_TX(uint8_t tmp_buf[32]);//发送数据
